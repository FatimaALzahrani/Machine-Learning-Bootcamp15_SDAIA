...
## جدول المحتويات
   ...
   * [ التعليم الموجّه](#التعليم_الموجّه)
        * [ K -NN  الجيران الاقرب ](#K_NN_الجيران_الاقرب)
...
### 2. **تعلُم غير موجّهUnsupervised Learning) ) /**
...
### 3.**تعلُم تعزيزيReinforcement Learning) ) /**
...
###### * تذكر : ما بنقدر نوصل لأعلى دقه مع تعميم رائع ، حيث انه فيه توازن بين الإثنين
...
### 2. **خوارزمية التحسين (  **/ (Algorithm Optimizationنزول التدرج هو خوارزمية تحسين ُتستخدم للعثور على قيم معاملات الدالة مثل $a_0$  و   $a_1$التي تقلل دالة التكلفة ، افضل صفة لها انها تكرارية . تبدأ من مكان ما على سطح دالة التكلفة حيث يتم رسم الدالة ، وتتخذ خطوة في اتجاه معين ثم بتقوم الخوارزمية التحسينية بالتكرار ببطء وتوجيهنا خطوة بخطوة للحد الأدنى لهذي الدالة (دالة التكلفة)
